...
class FoodRecordViewModel : ViewModel(), KoinComponent {
    ...
    private fun refresh() {
        ...
        totalCalorieRecorded = records.sumOf { it.mass * (it.food.energy.value / 100.0) }
            .toInt() + foodRecordRepository.customEnergyAmount
        ...
        totalCarbohydratesRecorded =
            records.sumOf { it.mass * (it.food.carbohydrates.value / 100.0) }.toInt()
